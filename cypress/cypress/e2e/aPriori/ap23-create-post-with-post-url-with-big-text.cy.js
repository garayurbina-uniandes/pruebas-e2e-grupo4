describe('Create post with post url with a big text', () => {
    let dataPool;
    try {
    ...
    it('Create a post', () => {
        ...
        cy.wait(2000);
        cy.log('dataPool data length: ', dataPool['stringBig'].length);
        cy.get('input[id="url"]').clear().type(dataPool['stringBig']);
        cy.wait(2000);
