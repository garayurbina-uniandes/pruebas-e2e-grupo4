...
describe('Como usuario creo una página, publicarla y validar que se agregue al listado de páginas con datos aleatorios', () => {
    before(() => {
...
describe('Como usuario creo una página, sin publicarla y validar que se agregue al listado de páginas con datos aleatorios', () => {
    before(() => {
        cy.visit('http://localhost:2373/ghost/#/signin')
    })
    it('Create an user and login', () => {
...
describe('Como usuario creo una página, sin publicarla, sin título y validar que se agregue al listado de páginas con datos aleatorios', () => {
    before(() => {
        cy.visit('http://localhost:2373/ghost/#/signin')
    })
    it('Create an user and login', () => {
...
describe('Como usuario creo una página, sin publicarla, sin descripción y validar que se agregue al listado de páginas con datos aleatorios', () => {
    before(() => {
        cy.visit('http://localhost:2373/ghost/#/signin')
    })
    it('Create an user and login', () => {
...
describe('Como usuario creo una página, programo publicarla y validar que se agregue al listado de páginas con datos aleatorios', () => {
    before(() => {
        cy.visit('http://localhost:2373/ghost/#/signin')
    })
    it('Create an user and login', () => {
