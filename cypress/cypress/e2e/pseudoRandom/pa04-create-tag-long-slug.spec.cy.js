describe('Testing Tag Creation with Invalid data, very long Name on Slug', () => {
    let imageSequence = 1;
    ...
    it('Create tag with invalid data', () => {
        ...
        cy.get('#tag-slug').type(randomPool['very_long_string'], { delay: 0}) // create Public tag with very long slug name
        cy.wait(2000);
