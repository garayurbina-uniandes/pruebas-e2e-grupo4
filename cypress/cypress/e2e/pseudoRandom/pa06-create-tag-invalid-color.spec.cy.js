describe('Testing Tag Creation with Invalid data, word in Color', () => {
    let imageSequence = 1;
    ...
    it('Create tag with invalid data', () => {
        ...
        cy.get('input[name="accent-color"]').type(randomPool['single_word'])// create Public tag with invalid color
        cy.wait(2000);
