describe('Testing Tag Creation with Invalid data, bad String on description', () => {
    let imageSequence = 1;
    ...
    it('Create tag with invalid data', () => {
        ...
        cy.get('#tag-description').type(randomPool['bad_string'])// create Public tag with bad description
        cy.wait(2000);
