describe('Testing Public Tag Creation with valid Canon url on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.get('span').contains('Expand').first().click(); // create Public tag with valid canon url
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(2000);
        cy.get('#canonical-url').type(randomPool['url'])
