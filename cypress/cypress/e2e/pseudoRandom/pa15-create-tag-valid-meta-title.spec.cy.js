describe('Testing Public Tag Creation with valid Meta title on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.get('span').contains('Expand').first().click(); // create Public tag with valid meta title
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(2000);
        cy.get('#meta-title').type(randomPool['single_word'])
