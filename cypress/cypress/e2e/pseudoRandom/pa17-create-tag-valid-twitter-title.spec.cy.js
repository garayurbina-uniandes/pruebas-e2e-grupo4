describe('Testing Public Tag Creation with valid Twitter title on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.get('span').contains('Expand').click()
         // create Public tag with valid twitter title
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(2000);
        cy.get('#twitter-title').type(randomPool['single_word'])
