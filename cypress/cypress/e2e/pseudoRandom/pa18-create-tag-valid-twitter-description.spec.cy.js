describe('Testing Public Tag Creation with valid Twitter Description on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.get('span').contains('Expand').click()
         // create Public tag with valid Twitter Description
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(2000);
        cy.get('#twitter-description').type(randomPool['single_word'])
