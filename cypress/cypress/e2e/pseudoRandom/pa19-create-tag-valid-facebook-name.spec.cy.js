describe('Testing Public Tag Creation with valid facebook title on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.wait(500);
        cy.get('span').contains('Expand').click()
         // create Public tag with valid facebook title
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(1000);
        cy.get('#og-title').type(randomPool['single_word'])
