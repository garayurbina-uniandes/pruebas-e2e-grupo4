describe('Testing Public Tag Creation with valid facebook description on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.wait(500);
        cy.get('span').contains('Expand').click()
         // create Public tag with valid facebook description
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(1000);
        cy.get('#og-description').type(randomPool['single_word'])
