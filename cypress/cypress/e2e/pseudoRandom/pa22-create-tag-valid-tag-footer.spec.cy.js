describe('Testing Public Tag Creation with valid Tag Footer on Ghost', () => {
    let imageSequence = 1;
    ...
    it('Create Public Tag', () => {
        ...
        cy.screenshot(`${prefixPath}/${imageSequence++}`, {overwrite: true});
        cy.wait(1000);
        cy.get('#tag-setting-codeinjection-foot').type(randomPool['single_word']) // create Public tag with valid Tag Footer
