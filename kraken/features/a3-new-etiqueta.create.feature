...
And I click on new save tag
And I wait for 1 seconds
Then I take screenshot of new ghost step "8" scenario "E04"
...
And I click on new save tag
And I wait for 1 seconds
Then I take screenshot of new ghost step "8" scenario "E05"

@user4 @web
Scenario: Como usuario visualizo una etiqueta creada en ghost si existe al menos una
Given I navigate to page "http://localhost:3002/ghost/#/signin"
When I take screenshot of new ghost step "1" scenario "E06"
And I enter email "a@a.com"
And I wait for 1 seconds
